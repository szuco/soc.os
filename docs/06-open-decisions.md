...
| 8 | **P1** | **Konkreter FET-Typ für Q1** — P-Kanal! (Verpolschutz high-side). Kandidat seit 20.08.: **Vishay SIR4409DP** (−40 V, 60 A, PowerPAK SO-8), bei Distributoren lieferbar, LCSC-Nummer nicht gefunden → Portal-Globalsuche | einziges Leistungsbauteil ohne Teilenummer; hängt am Blockierstrom |
