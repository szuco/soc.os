...
| 23 | 🟡 **Konzept entschieden 21.08.2026: kurzer Stapel.** Die Recherche ergab, dass es erhöhte 1,27-mm-THT-Buchsen mit 9 mm Bauhöhe **nicht gibt** — herstellerweit ist bei 4,0…4,6 mm Schluss (Samtec SFM 4,57 · Sullins 4,50 · Harwin 4,40 · Preci-Dip 4,00; LCSC-Vollauswertung über ~1.800 Teile mit Pitch 1,27: höchste 2×20-THT-Buchse 4,3 mm). Erhöhte Buchsen sind eine 2,54-mm-Bauform. Samtecs SFM+TFM käme auf 9,53 mm, bräuchte auf Mid aber **zwei Lochbilder** — dafür ist kein Platz (alle vier Kandidatenzonen belegt, u. a. vom ESP32-Modul) | **Statt eines Sonderteils wurde der Stapel verkürzt: Ebenenabstand 9,0 → 5,0 mm.** Damit passen gewöhnliche Katalogteile, das Durchsteck-Konzept bleibt (Mid trägt EIN Bauteil), und **kein Lochbild ändert sich**. Gegenprobe der Bauteilhöhen: unten Drossel 2,8, oben ESP32 3,2 und J6 4,25, die sich örtlich nicht überlappen. Nebeneffekt: 9 mm mehr Tiefenreserve (jetzt ≈ 25 mm) und Punkt 66 löst sich auf. **Buchse steht fest: LCSC `C41370657`** (Megastar ZX-PM1.27-2-20PU-Z, 4,3 mm, Einstecktiefe 2,4) auf Bottom und Top. **Offen bleibt nur der durchgesteckte Stift für Mid:** Er braucht ≥ 3,10 mm Überstand je Seite (Formel: Spalt = 4,3 − 2,4 + Überstand) — Suche läuft |
