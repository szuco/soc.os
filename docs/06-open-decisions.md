...
| 23 | ✅ **GELÖST 22.08.2026** | **Erhöhte 1,27-mm-THT-Buchsen mit 9 mm gibt es nicht** — herstellerweit ist bei 4,0…4,6 mm Schluss (LCSC-Vollauswertung ~1.800 Teile; Samtec SFM 4,57 · Sullins 4,50 · Harwin 4,40). Samtecs SFM+TFM käme auf 9,53 mm, bräuchte auf Mid aber zwei Lochbilder — dafür ist kein Platz. Und einen beidseitig 3,1 mm überstehenden Stift gibt es bei 1,27 mm ebenfalls nicht (alle Lötschwänze 2,1…2,6 mm) | **Stapel verkürzt statt Sonderteil: Ebenenabstand 9,0 → 6,0 mm.** Kein Lochbild ändert sich. **Korrigiertes Steckmodell:** Die 2,4 mm der Buchse sind ihr Lötpin, nicht die Einstecktiefe — beim Stecken stoßen die Kunststoffkörper aneinander, also *Spalt = Isolator + Buchse* und *Eingriff = Überstand − (Spalt − Buchse)*. Bei 5,0 mm würde **jeder** verfügbare Stift klemmen; 6,0 ist die nächste Standard-Hülsenlänge und lässt 1,35 mm Eingriff. **Teile:** Buchse **LCSC C41370657** (Megastar ZX-PM1.27-2-20PU-Z, 4,3 mm, 0,41 $, 3.867 St.) auf Bottom und Top; Stift **LCSC C43383** (BOOMELE 1.27-2×40P, Isolator 1,5, auf 2×20 kürzen, 30 St.) auf Mid. **Montage-hinweis:** Der Isolator muss beim Löten **1,45 mm angehoben** sitzen, damit der Pin beidseitig 3,05 mm übersteht — sonst erreicht er unten die Buchse nicht. THT bestückt JLCPCB ohnehin nicht, das ist Handarbeit mit einer 1,45-mm-Unterlage |
...
| # | Prio | Entscheidung | Bemerkung |
|---|---|---|---|
| 66 | ✅ **GELÖST 21.08.2026** | **Ein Millimeter Unterschied im Ebenenabstand.** `stack.py` setzte die Boardrückseiten auf 0 / 10 / 20 — also 9,0 mm frei zwischen den Platinen —, während docs/04 im Tiefenbudget 10,0 mm führte | Der Umbau auf den **kurzen Stapel** (Punkt 23) hat die Frage aufgelöst: Die Rückseiten liegen jetzt auf **0 / 6 / 12**, also **5,0 mm frei**, und die Tabelle in docs/04 Abschnitt 4 nennt dieselben 5,0. Modell und Doku sagen dasselbe; der Selbsttest der Explosionszeichnung prüft den Wert seither gegen 5,0 statt 10,0 |
