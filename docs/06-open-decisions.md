...
| 23 | 🟡 **Richtung entschieden (20.08.2026): Durchsteck-Stift auf Mid.** Bottom und Top bekommen ERHÖHTE 2×20-Buchsen (1,27 mm, Bauhöhe ~8,5, sodass die Steckebene an Mids Bohrungen liegt), Mid eine THT-Stiftleiste mit beidseitigem Überstand — kein Layout-Umbau, die Bohrbilder bleiben. Offen ist nur noch das konkrete Teilepaar: Anforderung Buchse H ≈ 8,5 (Einstecktiefe ≥ 2,5), Stift beidseitig ≥ 3 über Platine; Quellen Wayconn/Scondar/Samtec-Katalog | Teilepaar aus Katalog wählen, Maßkette gegen 10-mm-Ebenenabstand prüfen |
