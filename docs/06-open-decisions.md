...
| 23 | 🟡 **Richtung entschieden (20.08.2026): Durchsteck-Stift auf Mid.** Bottom und Top bekommen ERHÖHTE 2×20-Buchsen (1,27 mm), Mid eine THT-Stiftleiste mit beidseitigem Überstand — kein Layout-Umbau, die Bohrbilder bleiben (alle drei Boards tragen `PinSocket_2x20_P1.27mm_Vertical`, Bohrung 0,70 mm, Pad 1,00 mm, Umriss 6,1 × 30,1) | **Maßkette gerechnet am 21.08.:** Bottom-Vorderseite z = 1,0, Mid-Rückseite z = 10,0 → **9,0 mm freier Abstand**, oben identisch. Die Buchse braucht also **9,0 mm Bauhöhe über der Platine** (nicht 8,5), damit die Steckebene an Mids Bohrung liegt; Einstecktiefe ≥ 2,5. Stift: Gesamtlänge ≥ 6,0 mm (2,5 + 1,0 Platine + 2,5), gern länger. Im Zwischenraum stehen nur flache Teile (höchstes: Drossel SRP7028A, 2,8 mm) — die 9,0 mm sind wirklich frei. Teilepaar-Recherche läuft |
