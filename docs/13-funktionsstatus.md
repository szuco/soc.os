...
| **TOP** `top_ui` | ✅ 26 Bauteile — kein USB; ToF und Raumsensor symmetrisch bei ±5,5, Hauptschalter SW5 hochkant daneben | 🟡 **vierlagig, 203 Segmente, 21 Vias, null Kupferfehler**; Display DIREKT gelötet (0,7-Raster, Lötfeld vorn) — nur noch 4 offene Verbindungen | ⛔ Handarbeit |
